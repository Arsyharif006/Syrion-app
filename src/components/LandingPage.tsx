...
export const LandingPage: React.FC<LandingPageProps> = ({ onAuthSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      ...
      {/* Navbar */}
      <nav className={`fixed left-0 right-0 bg-[#1a1a1a]/95 backdrop-blur-sm border-b border-gray-800 z-40 transition-all ${showPromoBanner ? 'top-[95px] sm:top-[50px]' : 'top-0'}`}>
